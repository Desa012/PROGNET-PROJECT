        ...
        @foreach($keranjangs as $item)
            <div class="cart-item">
                ...
                <div class="jumlah">
                    ...
                    <button class="minus"
                        style="font-size: 18px; background-color: #007bff; color: white; border: none; padding: 5px 10px; cursor: pointer;"
                ...
                <p>Total: Rp <span
                        id="total-{{ $item->id_keranjang }}">{{ number_format($item->produks->harga * $item->jumlah, 0, ',', '.') }}</span>
                </p>
