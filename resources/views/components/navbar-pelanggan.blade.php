<nav class="bg-gradient-to-b from-blue-800 to-blue-900 border-gray-200">
    <div class="flex items-center justify-between w-full px-8 py-4">
        ...
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <svg class="w-[34px] h-[34px] text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <form class="flex-grow mx-4" style="width: 300px;">
            ...
            <div class="relative">
                ...
                <button type="submit" class="text-white absolute end-2.5 bottom-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cari</button>
            </div>
        </form>


        {{-- Saldo pelanggan --}}
        <div class="flex items-center space-x-2 px-4 py-2.5 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-600">
            {{-- Logo dompet --}}
        ...
        <div class="flex items-center space-x-6 px-4">
            ...
            <div class="flex items-center md:order-2 space-x-4 md:space-x-2 rtl:space-x-reverse relative">
                ...
                {{-- Gambar profil --}}
                <button id="dropdownHoverButton" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover" class="flex items-center space-x-3 bg-transparent focus:outline-none">
                ...
                <!-- Dropdown menu -->
                <div id="dropdownHover" class="absolute hidden z-50 mt-2 w-44 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
                    <div class="px-4 py-3">
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton">
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Pengaturan</a>
                        </li>
                        <li>
