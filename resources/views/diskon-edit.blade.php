<x-layout>
    <x-slot:header>Edit Diskon</x-slot>
    <form class="max-w-md mx-auto" method="POST" action="{{ route('diskons.update',$diskon['id_diskon']) }}">
        @csrf
        @method('PUT')
        <div class="relative z-0 w-full mb-5 group">
            <input type="number" name="persentase_diskon" id="persentase_diskon" value="{{ $diskon['persentase_diskon'] }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="date" name="tanggal_mulai" id="tanggal_mulai" value="{{ $diskon['tanggal_mulai'] }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="date" name="tanggal_selesai" id="tanggal_selesai" value="{{ $diskon['tanggal_selesai'] }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
